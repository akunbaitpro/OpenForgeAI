  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        cell: "h-9 w-9 text-center text-sm p-0 relative [&:has([aria-selected].day-range-end)]:rounded-r-md [&:has([aria-selected].day-outside)]:bg-accent/50 [&:has([aria-selected])]:bg-accent first:[&:has([aria-selected])]:rounded-l-md last:[&:has([aria-selected])]:rounded-r-md focus-within:relative focus-within:z-20 [&:has(.day-hover-range)]:bg-accent/50 [&:has(.day-hover-range)]:rounded-none first:[&:has(.day-hover-range)]:rounded-l-md last:[&:has(.day-hover-range)]:rounded-r-md",
        day: cn(
